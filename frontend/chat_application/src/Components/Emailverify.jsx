...
function Emailverify() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://realtimechat-backend-bu2v.onrender.com/api/auth/verify",
        {
  ...
  const resendOtp = async () => {
    ...
    try {
      // Fixed API call using axios properly
      const response = await axios.post(
        "https://realtimechat-backend-bu2v.onrender.com/api/auth/resend-otp",
        {
          email: email,
        }
      );
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              {timer > 0 ? (
                ...
                <p className="text-sm text-red-400 mb-2">Code has expired</p>
              )}
            </div>
